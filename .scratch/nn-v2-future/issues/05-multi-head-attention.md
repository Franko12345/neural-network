...
- [ ] `transformer/__init__.py` empty
- [ ] `transformer/attention.py`: `MultiHeadAttention(d_model, n_heads)`:
...
- [ ] Headless smoke: forward + backward + check grads shape
- [ ] ponytail: one class, no helper functions exposed; mask applied
